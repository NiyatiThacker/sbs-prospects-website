        ...
        <div className="sbs-footer-grid">
          ...
          <div className="sbs-footer-brand-col">
            ...
            <div className="sbs-social-row">
              ...
              <a href="https://youtube.com/@sbsprospects?si=zz2EUNcw8B8O4c4K" target="_blank" rel="noopener noreferrer" className="sbs-social-btn" title="YouTube">
          ...
          <div>
            ...
            {[
              { label: "Career Programs", href: "/services#career-guidance" },
              { label: "Placement Assistance", href: "/services#recruitment-support" },
              { label: "Internship Support", href: "/services#internships" },
              { label: "Industry Based Training", href: "/services#training-courses" },
              { label: "Live Projects", href: "/services#internships" },
              { label: "MBA Skill Development", href: "/services#mba-skills" },
              { label: "HR & Consultancy", href: "/services#hr-consultancy" }
            ].map((item) => (
              <Link key={item.label} href={item.href} onClick={() => handleLinkClick(item.href)} className="sbs-footer-link">{item.label}</Link>
            ))}
          </div>
